  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
        <Link href='/' className="flex gap-2 flex-center">
            <Image src='/public/assets/images/logo.svg' alt="Promptopia Logo" width={30} height={30} className="object-contain" />
        ...
        <div className="sm:flex hidden">
            {isUserLoggedIn ? (
                <div className="flex gap-3 md:gap-5">
                    ...
                    <Link href='/profile'>
                        <Image src="/public/assets/images/grid.svg" width={37} height={37} className="rounded-full" alt="profile"/>
                    </Link>
                </div>
            ) : (
                <>
